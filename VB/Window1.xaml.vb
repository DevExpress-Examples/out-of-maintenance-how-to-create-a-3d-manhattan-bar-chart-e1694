...
Namespace ManhattanBar3DChart
	...
	Public Class DevAVSalesByYear
		...
		Public ReadOnly Property Series1Source() As DataTable
			Get
				Return GetData().AsEnumerable().Where(Function(r) r.Field(Of Integer)("Year") = DateTime.Now.Year - 1).CopyToDataTable()
			End Get
		End Property
		Public ReadOnly Property Series2Source() As DataTable
			Get
				Return GetData().AsEnumerable().Where(Function(r) r.Field(Of Integer)("Year") = DateTime.Now.Year - 2).CopyToDataTable()
			End Get
		End Property
		Public ReadOnly Property Series3Source() As DataTable
			Get
				Return GetData().AsEnumerable().Where(Function(r) r.Field(Of Integer)("Year") = DateTime.Now.Year - 3).CopyToDataTable()
			End Get
		End Property
